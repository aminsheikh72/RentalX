      ...
      <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2">
            ...
            <li><a href="/cars" className="hover:text-red-500 transition">Rent a Car</a></li>
        ...
        <div>
          ...
          <ul className="mt-3 space-y-2">
            ...
            <li className="flex items-center"><Phone className="mr-2" /> +91 9329394737</li>
            <li className="flex items-center"><Mail className="mr-2" /> asgaming865@gmail.com</li>
          </ul>
        </div>
      </div>
